<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminLogin.aspx.cs" Inherits="EAVS.AdminLogin" %>
...
<head runat="server">
    ...
    <style>
        ...
        body{
            background-image:url('Asset/img/admLogBACK.jpg');
        ...
        <div class="row mt-5 mb-5">
            ...
            <div class="col-md-4">
                <form id="loginForm" runat="server" autocomplete="off">
                    ...
                    <div>
                        <a href="StaffLogin.aspx" style="float:right; color:saddlebrown;"><b> STAFF Login </b></a>
                        
                    </div><br />
                    <div>
                        <a href="Login.aspx" style="float:right; color:saddlebrown;"><b> STUDENT Login </b> </a>
                    </div><br />
                    ...
                    <div style="text-align:center;font-family:Monaco;">
                        ...
                        <span class="adminText">Admin Login</span>
                   ...
                   <asp:Label ID="msgLogin" runat="server"></asp:Label><br />                 
