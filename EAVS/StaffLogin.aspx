<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StaffLogin.aspx.cs" Inherits="EAVS.StaffLogin" %>
...
<head runat="server">
    ...
    <style>
        ...
        body{
            background-image:url('Asset/img/stfLogBACK.jpg');
        ...
        <div class="row mt-5 mb-5">
            ...
            <div class="col-md-4">
                <form id="loginForm" runat="server" autocomplete="off">
                    ...
                    <div>
                        <a href="Login.aspx" style="float:right; color:brown;"><b> STUDENT Login </b></a>
                        
                    </div><br />
                    <div>
                        <a href="AdminLogin.aspx" style="float:right; color:brown;"><b> ADMIN Login </b></a>
                    </div><br />
                    ...
                    <div style="text-align:center;font-family:Monaco;">
                        ...
                        <span class="stfText">Staff Login</span>


                    </div>
                    <div class="mt-3">
                        <label for="" class="form-label" style="color:darkred;"><b>User Name</b></label>
                        <asp:TextBox autofocus ID="txtUname" runat="server" placeholder="username" class="form-control"></asp:TextBox>
                    </div>
                    <div class="mt-3">
                        <label for="" class="form-label" style="color:darkred;"><b>Password</b></label>
                        ...
                        <div id="showPass" style="float:right"> 
                           <input type="checkbox" onchange="document.getElementById('txtPwd').type = this.checked ? 'text' : 'password'"/>
                            <label for="" style="color:brown;"><b>Show Password</b></label> 
                        </div><br />
                   ...
                   <!--<a href="ForgotPass.aspx" style="color:darkslategrey"><b>Forgot Password?</b></a><br />-->
